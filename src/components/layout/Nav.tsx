  ...
  return (
    <div className="w-full flex flex-col lg:px-[100px] px-[20px] lg:py-[20px] py-[10px]">
      ...
      <div className="hidden lg:flex justify-between items-center">
        ...
        <Link href={"/Newest"}><li className='w-[45px] h-[24px] font-medium leading-[24px] '>Shop</li></Link>
      ...
      <div className="lg:hidden flex justify-between  px-[30px]">
        ...
        <Link href={"/Newest"}><li className='font-medium hover:text-bordercoloryello '>Shop</li></Link>
